...
class ImageDataset(Dataset):
    def __init__(self, SUV_MIP_files, SUV_bone_files, SUV_lean_files, SUV_adipose_files, SUV_air_files, CT_MeanIP_files, CT_bone_files, CT_lean_files, CT_adipose_files, CT_air_files, SUV_TSeg_MIP_files, CT_TSeg_MeanIP_files, time, labels, channel_flag):
    ...
    def __getitem__(self, index):
        ...
        if self.channel_flag=="SUV_CT_T_13":
        ...
        return multi_channel_input, time, labels
    
def prepare_data_binary_withTime(args, df_train, batch_size, shuffle=None, label=None, channel_flag="SUV_CT_T_13"):
    if shuffle==True:
    ...
    time = df_train_shuffled["days_period"]
     
    train_files = [
        {"SUV_MIP": SUV_MIP_name, "SUV_bone": SUV_bone_name, "SUV_lean": SUV_lean_name, "SUV_adipose": SUV_adipose_name, "SUV_air": SUV_air_name, 
         "CT_MeanIP": CT_MeanIP_name, "CT_bone": CT_bone_name, "CT_lean": CT_lean_name, "CT_adipose": CT_adipose_name, "CT_air": CT_air_name, "SUV_TSeg_MIP": SUV_TSeg_MIP_name, "CT_TSeg_MeanIP": CT_TSeg_MeanIP_name, "time": time, "labels": labels}
         for SUV_MIP_name, SUV_bone_name, SUV_lean_name, SUV_adipose_name, SUV_air_name, CT_MeanIP_name, CT_bone_name, CT_lean_name, CT_adipose_name, CT_air_name, SUV_TSeg_MIP_name, CT_TSeg_MeanIP_name, time, labels in
         zip(SUV_MIP_train, SUV_bone_train, SUV_lean_train, SUV_adipose_train, SUV_air_train, CT_MeanIP_train, CT_bone_train, CT_lean_train, CT_adipose_train, CT_air_train, SUV_TSeg_MIP_train, CT_TSeg_MeanIP_train, time, label_train)
    ]

    train_ds = ImageDataset(SUV_MIP_train, SUV_bone_train, SUV_lean_train, SUV_adipose_train, SUV_air_train, CT_MeanIP_train, CT_bone_train, CT_lean_train, CT_adipose_train, CT_air_train, SUV_TSeg_MIP_train, CT_TSeg_MeanIP_train, time, label_train, channel_flag)
