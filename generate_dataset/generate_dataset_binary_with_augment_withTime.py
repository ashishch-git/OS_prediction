...
class ImageDataset(Dataset):
    def __init__(self, train_files, times, label_files, transform):
    ...
    def __getitem__(self, index):
        ...
        return files_new["PET_CT"], time, labels
...
def prepare_data_binary_withTime(args, df_train, batch_size, shuffle=None, label=None, channel_flag="SUV_CT_T_13"):
    ...
    #numerical feature
    time_train = df_train_shuffled["days_period"]
     
    train_files = [
        {"SUV_MIP": SUV_MIP_name, "SUV_bone": SUV_bone_name, "SUV_lean": SUV_lean_name, "SUV_adipose": SUV_adipose_name, "SUV_air": SUV_air_name, 
         "CT_MeanIP": CT_MeanIP_name, "CT_bone": CT_bone_name, "CT_lean": CT_lean_name, "CT_adipose": CT_adipose_name, "CT_air": CT_air_name, "SUV_TSeg_MIP": SUV_TSeg_MIP_name, "CT_TSeg_MeanIP": CT_TSeg_MeanIP_name, "time": time}
         ...
         zip(SUV_MIP_train, SUV_bone_train, SUV_lean_train, SUV_adipose_train, SUV_air_train, CT_MeanIP_train, CT_bone_train, CT_lean_train, CT_adipose_train, CT_air_train, SUV_TSeg_MIP_train, CT_TSeg_MeanIP_train, time_train, label_train)
    ]

    times = [time for time in time_train]
    ...
    train_ds = ImageDataset(train_files, times, label_files, transform=train_transforms)
